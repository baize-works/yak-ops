...
import io.yak.ops.dao.mapper.UserMapper;
...
public class UserPersistenceAdapter implements UserRepository {
    ...
    @Override public Optional<User> findByUserName(String userName) {
        return Optional.ofNullable(mapper.selectOne(new LambdaQueryWrapper<io.yak.ops.dao.entity.User>()
                .eq(io.yak.ops.dao.entity.User::getUserName, userName))).map(this::toModel);
    }
    @Override public Optional<User> findById(int userId) { return Optional.ofNullable(mapper.selectById(userId)).map(this::toModel); }
    private User toModel(io.yak.ops.dao.entity.User entity) {
