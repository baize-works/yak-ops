...
@Component
public class DefaultLinkUpTestJobExecutor implements LinkUpTestJobExecutor {
 private final EngineGatewayRegistry gateways;
 public DefaultLinkUpTestJobExecutor(EngineGatewayRegistry gateways) { this.gateways = gateways; }
 @Override public JobExecutionResult executeAndWait(LinkUpClient client, ConnectivityTestJob job, long timeoutMs, long pollIntervalMs) {
