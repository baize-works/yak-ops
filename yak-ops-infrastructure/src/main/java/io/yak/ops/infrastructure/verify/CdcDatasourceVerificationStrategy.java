...
@Component
public class CdcDatasourceVerificationStrategy
        implements DatasourceVerificationStrategy {

    @Resource
    private JdbcDatasourceVerificationStrategy jdbcDatasourceVerificationStrategy;
    ...
    public ClientDatasourceVerifyVO verify(DatasourceVerifyContext context) {
        ...
        ClientDatasourceVerifyVO jdbcResult =
                jdbcDatasourceVerificationStrategy.doVerify(context);
