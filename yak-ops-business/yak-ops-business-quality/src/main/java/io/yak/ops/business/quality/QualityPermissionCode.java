...
public final class QualityPermissionCode {
  ...
  public static final String MONITOR_DELETE = "quality:monitor:delete";
  public static final String MONITOR_RUN = "quality:monitor:run";
  public static final String EXECUTION_READ = "quality:execution:read";

  private QualityPermissionCode() {
  }
}
