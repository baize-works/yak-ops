...
/** Executes one durable data-development execution through a task plugin. */
...
public class DataDevelopmentExecutionWorker {
  ...
  public void execute(long executionId) {
    ...
    TaskExecutor executor = taskPluginCatalog.createExecutor(execution.taskType());
