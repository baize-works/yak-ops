...
> {
  return HttpUtils.get(`${DATA_SOURCE_API_PREFIX}/summary`);
}
...
export async function testDataSourceConnection(
  ...
  return HttpUtils.post(`${DATA_SOURCE_API_PREFIX}/${id}/connect-test`, {});
}
...
export const dataSourceCatalogApi = {
  listTable: (
    ...
    HttpUtils.get(`${DATA_SOURCE_CATALOG_API_PREFIX}/list/${id}`),
