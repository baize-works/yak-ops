...
export const appRoutes: readonly NavigationRoute[] = [
  ...
  { id: 'data-quality-table-config', mode: 'one', permission: 'quality:monitor:read', path: '/data-quality/table-config', title: '按表配置', component: './data-quality/table-config', iconKey: 'quality', menuGroup: 'data-quality', order: 10 },
  { id: 'data-quality-monitor-create', path: '/data-quality/monitor/create', title: '新建质量监控', component: './data-quality/monitor/editor', hidden: true, parentId: 'data-quality-table-config' },
