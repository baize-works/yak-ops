...
public class LinkUpClientResolver {
    private final EngineConnectionConfigProvider connections;
    public LinkUpClientResolver(EngineConnectionConfigProvider connections) { this.connections = connections; }
    ...
    private EngineConnectionConfig connection(Long clientId) {
        if (clientId == null) throw new IllegalArgumentException("LinkUp client id must not be null");
