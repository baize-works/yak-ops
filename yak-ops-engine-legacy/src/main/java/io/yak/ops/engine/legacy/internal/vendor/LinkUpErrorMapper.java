...
final class LinkUpErrorMapper {
    private LinkUpErrorMapper() { }
    ...
    private static Map<String, String> diagnostics(Exception cause) {
        ...
        return java.util.Collections.unmodifiableMap(new java.util.LinkedHashMap() {{ put("vendor", "linkup"); put("vendor.error_code", cause.getClass().getSimpleName()); }});
    }
}
