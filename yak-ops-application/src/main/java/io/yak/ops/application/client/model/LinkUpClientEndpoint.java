...
/**
 * Runtime endpoint model of a LinkUp client node.
 *
 * <p>This model represents one accessible LinkUp REST endpoint. It can be a
...
@Data
@Builder
public class LinkUpClientEndpoint {
     ...
     * Endpoint host.
     *
     * <p>For example: 127.0.0.1 or linkup-master-1.</p>
     */
    private String host;
    ...
    /**
     * LinkUp client version resolved from this endpoint.
     *
