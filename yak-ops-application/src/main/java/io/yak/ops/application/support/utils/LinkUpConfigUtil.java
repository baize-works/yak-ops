package io.yak.ops.application.support.utils;

/**
 * Utility class for generating LinkUp job configuration text.
 *
 * <p>
 * This class assembles a complete LinkUp configuration
 * by injecting env, source, transform, and sink sections
 * into a predefined template.
 * </p>
 */
public class LinkUpConfigUtil {

    private static final String INDENT = "    ";

    /**
     * Base LinkUp configuration template.
     *
     * <p>
    ...
    /**
     * Generate a complete LinkUp configuration string.
     *
     ...
     * @return assembled LinkUp configuration text
     */
