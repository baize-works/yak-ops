...
/**
 * Runtime topology model of a LinkUp client.
 *
 * <p>This model describes how a LinkUp client is deployed and which endpoints
...
@Data
@Builder
public class LinkUpClientTopology {
    ...
    /**
     * Master endpoints of the LinkUp client.
     *
     * <p>Master nodes are used as runtime entry points for REST API calls.</p>
     */
    private List<LinkUpClientEndpoint> masters;

    /**
     * Worker endpoints of the LinkUp client.
     *
     * <p>Worker nodes are mainly used for topology display and health diagnostics.</p>
     */
    private List<LinkUpClientEndpoint> workers;
