...
/**
 * Runtime specification of a LinkUp client.
 *
...
public class LinkUpClientSpec {
     ...
     *
     * <p>For the current implementation, this usually represents the LinkUp
    ...
    /**
     * Protocol used to access LinkUp REST endpoints.
     *
     ...
     */
    private List<LinkUpClientEndpoint> masterEndpoints;
     ...
     */
    private List<LinkUpClientEndpoint> workerEndpoints;

    /**
     * Authentication information used to access LinkUp REST endpoints.
     */
